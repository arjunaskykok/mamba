...
class TestPackageManager(TestWithContracts):
    ...
    def setup_method(self, method):
        ...
        self.packages_dir = self.tmp_path / Path('_ethpm_packages')
        self.parent_manifest_dir = self.packages_dir / "owned"
        self.manifest_file = self.parent_manifest_dir / "manifest.json"
        self.use_infura()
    ...
    def teardown_method(self, method):
        ...
        if self.parent_manifest_dir.exists():
            self.parent_manifest_dir.rmdir()
