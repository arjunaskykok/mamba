...
class TestTest(TestWithContracts):
    ...
    def test_get_contract_object(self):
        ...
        hello_world_contract = contract("HelloWorld", contract_directory=Path("/tmp/mamba_tests"))
    ...
    def test_get_contract_with_parameters_object(self):
        ...
        hello_parameters_contract = contract("HelloParameters", [b"Hello Parameters", 45], contract_directory=Path("/tmp/mamba_tests"))
